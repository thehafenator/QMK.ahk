...
/*
    ...
    This demo follows the general order of TUTORIAL.md.
...
introResult := MsgBox(
    ...
    . "Click OK to begin. When you finish, you can open TUTORIAL.md "
...
DemoPlaygroundText(title) {
    switch title {
        ...
        case "11. Demo complete":
            return "Everything you enabled during the demo is still active.`r`n`r`nTry anything again here, explore QMK Settings if you want, then open the full TUTORIAL.md when you are ready to build your own setup."
    }
...
Lesson5() {
    SetLesson(
        ...
        CodeLines(
            Chr(59) . " QMK Settings -> Timing",
            "quietPeriodDuration = 150 ms",
            "",
            Chr(59) . " Normal combos respect rollover / quiet-period behavior:",
            "[""a"", ""h"", ""global"", QMK.SendKeyDirect(""^{Left}"")]",
            "",
            Chr(59) . " Instant combos fire as soon as recognized:",
            "[""a"", """ . Chr(59) . """, ""global"", QMK.SendKeyDirect(""{Backspace}""), ""instant""]"
        )
    )
}
...
Lesson6() {
    SetLesson(
        ...
        CodeLines(
            ...
            "",
            Chr(59) . " Four-key shape:",
            Chr(59) . " [""a"", ""s"", ""d"", ""h"", ""global"", (*) => SomeFunction()],",
            "",
            Chr(59) . " Five-key shape:",
            Chr(59) . " [""a"", ""s"", ""d"", ""f"", ""o"", ""global"", (*) => AnotherFunction()],",
            "])"
        )
    )
}
...
SetupDemoCombos() {
    QMK.SetupCombos([
        ...
        ["c", "o", "global", QMK.SendKeyDirect("9")],
        ["c", "Space", "global", QMK.SendKeyDirect("0")],
        ["c", Chr(59), "global", QMK.SendKeyDirect("{Backspace}")],
